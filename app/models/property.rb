class Property < ActiveRecord::Base
  ...
  def self.show_all_featured
    #home_page
    Property.find(:all, :select => "id, name, permalink, location, developer_id, starting_price, target_completion_date, photo_file_name, photo_content_type, photo_file_size, photo_updated_at, as_low_as_label, as_low_as, sold_out, preselling",
